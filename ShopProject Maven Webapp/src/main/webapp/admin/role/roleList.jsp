...
<html lang="zh-CN">
	...
	<body>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-header">权限管理 <small>权限列表</small></h1>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
									...
									<tbody>
										<c:forEach items="${pb.beanList}" var="role">
											<tr>
												...
												<td>${role.remark }</td>
												<td>
													<a title="修改" href="/RoleServlet?method=preEdit&rid=${role.rid }" class="t-edit glyphicon glyphicon-pencil"></a>
													<a title="删除" href="/RoleServlet?method=delete&rid=${role.rid }" class="t-del glyphicon glyphicon-trash"></a>
												</td>
											</tr>
										</c:forEach>										
									</tbody>
