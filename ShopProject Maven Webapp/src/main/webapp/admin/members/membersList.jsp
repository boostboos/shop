					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="table-responsive">
								<a href="/admin/members/queryMembers.jsp">
								...
								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tbody>
										<c:forEach items="${pb.beanList}" var="members">
												<tr class="odd gradeX">
													<td>${members.meid}</td>
													...
													<td>${members.score}</td>
													<td> 
														<a title="删除" href="/MemberServlet?method=delete&meid=${members.meid }" class="t-del glyphicon glyphicon-trash"></a>
