				...
				<div class="user-address">
					...
					<ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails">
						...
						<c:forEach items="${addressList }" var="address">
							<c:if test="${address.defaddress == 0 }">
								<li class="user-addresslist ">
							</c:if>
							<c:if test="${address.defaddress == 1 }">
								<li class="user-addresslist defaultAddr">
							</c:if>
							<span class="new-option-r" onclick="fun(${address.aid})"><i class="am-icon-check-circle" ></i>默认地址</span>	
							<c:set value="${i+1}" var="i"></c:set>					
								<p class="new-tit new-p-re">
									<span class="new-txt">${address.receivername}</span> <span
										class="new-txt-rd2">${address.receiverphone}</span>
								</p>
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="title">${address.addressinfo}</span>
									</p>
								</div>
								<div class="new-addr-btn">
									<a href="/AddressServlet?method=preEdit&aid=${address.aid}&meid=${address.meid}" >
									<i class="am-icon-edit"></i>编辑</a> 
									<span class="new-addr-bar">|</span> 
									<a href="/AddressServlet?method=delete&aid=${address.aid }&meid=${address.meid} ">
						...
						<script type="text/javascript">
							function fun(obj){
								...
								xmlhttp.open("GET", "/AddressServlet?method=preEdit1&aid="+obj, true);
								xmlhttp.send();
							}					
						</script>
					...
					<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<!--标题 -->
						<div class="am-cf am-padding">
							<div class="am-fl am-cf"><input class="am-text-danger am-text-lg" id="am-text-danger am-text-lg" value="新增地址&nbsp;/Add&nbsp;address" readonly="true" style="border:none;"> </div>
						</div>
						<hr/>
						<div class="add-dress" id="add-dress">
							<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
								<form action="/AddressServlet" class="am-form am-form-horizontal">
									<input type="hidden" name="method" value="add" />
									<input type="hidden" name="defaddress" value="0" />
									<div class="am-form-group">
										<div class="am-form-content">
											<input type="hidden" name="meid" value="${session_memb.meid}" type="text">
										</div>
									</div>
									<div class="am-form-group">
									...
									<div class="am-form-group">
										...
										<div class="am-form-content">
											<textarea class="" rows="3" id="user-intro"
												name="addressinfo" placeholder="输入详细地址"></textarea>
						...
						function add(obj)
						{
							document.getElementById("edit-dress").style.display="none";//隐藏
							document.getElementById("add-dress").style.display = "";
							document.getElementById("am-text-danger am-text-lg").value="新增地址 / Add address";
						}
						function edit(obj)
						{
							document.getElementById("add-dress").style.display="none";//隐藏
							document.getElementById("edit-dress").style.display="";//显示
							document.getElementById("am-text-danger am-text-lg").value="修改地址 / Edit address";
						}					
						</script>						
					</div>
				</div>
				...
				<script type="text/javascript">	
					$(document).ready(function() {
						...
						$(".new-option-r").click(function() {
							...
							//}
							//alert("aaa");
							//xmlhttp.open("GET", "/AddressServlet?method=preEdit1&aid="+${address.aid}, true);
							//alert(${address.aid});
