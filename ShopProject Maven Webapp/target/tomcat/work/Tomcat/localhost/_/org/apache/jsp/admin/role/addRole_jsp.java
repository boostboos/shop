 ...
 * Generated at: 2018-07-10 01:45:03 UTC
...
public final class addRole_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                          \t添加角色 <small>添加角色信息</small>\r\n");
      out.write("                     </h1>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<form action=\"/RoleServlet\" method=\"post\">\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"method\" value=\"add\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"txtRolename\">角色名</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"roleName\" id=\"txtRolename\" placeholder=\"roleName\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"authority\" id=\"txtAuthority\" placeholder=\"authority\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
